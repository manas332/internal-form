/**
 * One-off script: Fetch INV-000436 from Zoho and insert into MongoDB.
 *
 * Usage:  npx tsx scripts/sync_inv_000436.ts
 */
...
async function main() {
    ...
    const INVOICE_NUMBER = 'INV-000436';
